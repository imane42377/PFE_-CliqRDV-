            ...
            <form id="providerForm" action="insert_prestataire.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="experience" name="experience" placeholder="Décrivez vos expériences professionnelles principales..." ></textarea>
                    </div>
                    <div class="form-group">
                        <label for="diplomas">Diplômes :</label>
                        <textarea id="diplomas" name="diplomas" placeholder="Listez vos diplômes et certifications..." ></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <input type="text" id="consultation_fee" name="consultation_fee" placeholder="Ex: 300 MAD" >
                </div>
